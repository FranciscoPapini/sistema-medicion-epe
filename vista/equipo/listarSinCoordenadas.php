...
?> 
    <div class="container" id="non-printable">
      ...
      <table class="table table-striped table-bordered table-hover" id="tableListar">
        ...
        <tbody>
          <?php
          $arrayEquipos = $equipoNegocio->listarTodosSinCoord();
          ...
          ?>
              ...
              <td>
                ...
                { ?>
                  <a href="?modulo=equipo&accion=editar&id=<?php echo $equipo->getId();?>&coord=1" data-toggle="tooltip" title="Editar Equipo"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
                <?php 
                } ?> 
