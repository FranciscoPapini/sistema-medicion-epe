...
?>
    <div class="container" >
      ...
      <div class="page-header" >
        <h1>Equipos con Problemas    
                  <a href="?modulo=equipo&accion=reporteProblemas" target="_blank" class="pull-right"><button type="button" class="btn btn-info btn-sm pull-right">Imprimir en Detalle</button></a><div class="pull-right">&nbsp;</div>
                  <a href="?modulo=equipo&accion=reporteProblemasLista" target="_blank" class="pull-right"><button type="button" class="btn btn-info btn-sm pull-right">Imprimir en Lista</button></a>
        </h1>
      </div>                   
